-- AlterTable
ALTER TABLE "TradeJournal" ADD COLUMN "strategyId" TEXT;
...
INSERT INTO "new_Settings" ("atrSlMult", "atrTpMult", "autoIntervalMinutes", "autoMinConfidence", "autoMode", "autoTimeframe", "autoTradeEnabled", "autoWatchlist", "balanceUtilization", "dailyMaxLoss", "dailyMaxWin", "discordWebhookEnc", "enabledStrategies", "geminiKeyEnc", "geminiModel", "id", "liveAcknowledged", "liveAutoAcknowledged", "maxOpenTrades", "maxUnits", "minRiskReward", "oandaAccountId", "oandaEnv", "oandaTokenEnc", "riskPercent", "sizingMode", "strategyMinVotes", "updatedAt", "weeklyMaxLoss", "weeklyMaxWin") SELECT "atrSlMult", "atrTpMult", "autoIntervalMinutes", "autoMinConfidence", "autoMode", "autoTimeframe", "autoTradeEnabled", "autoWatchlist", "balanceUtilization", "dailyMaxLoss", "dailyMaxWin", "discordWebhookEnc", "enabledStrategies", "geminiKeyEnc", "geminiModel", "id", "liveAcknowledged", "liveAutoAcknowledged", "maxOpenTrades", "maxUnits", "minRiskReward", "oandaAccountId", "oandaEnv", "oandaTokenEnc", "riskPercent", "sizingMode", "strategyMinVotes", "updatedAt", "weeklyMaxLoss", "weeklyMaxWin" FROM "Settings";
DROP TABLE "Settings";
